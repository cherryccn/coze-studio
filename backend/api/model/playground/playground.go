...
type SpaceConfigV2 struct {
	EnableWorkflow *bool `thrift:"enable_workflow,1,optional" form:"enable_workflow" json:"enable_workflow,omitempty" query:"enable_workflow"`
}

func NewSpaceConfigV2() *SpaceConfigV2 {
	return &SpaceConfigV2{}
}

func (p *SpaceConfigV2) GetEnableWorkflow() (v bool) {
	if p.EnableWorkflow != nil {
...
type SaveSpaceV2Request struct {
	SpaceID        *int64         `thrift:"space_id,1,optional" form:"space_id" json:"space_id,omitempty" query:"space_id"`
	...
	IconURI        string         `thrift:"icon_uri,4,required" form:"icon_uri,required" json:"icon_uri,required" query:"icon_uri,required"`
	...
	SpaceMode      *SpaceMode     `thrift:"space_mode,6,optional" form:"space_mode" json:"space_mode,omitempty" query:"space_mode"`
	SpaceConfig    *SpaceConfigV2 `thrift:"space_config,7,optional" form:"space_config" json:"space_config,omitempty" query:"space_config"`
	EnterpriseID   *int64         `thrift:"enterprise_id,8,optional" form:"enterprise_id" json:"enterprise_id,omitempty" query:"enterprise_id"`
	OrganizationID *int64         `thrift:"organization_id,9,optional" form:"organization_id" json:"organization_id,omitempty" query:"organization_id"`
	Base           *base.Base     `thrift:"Base,255,optional" form:"-" json:"-" query:"-"`
}

func NewSaveSpaceV2Request() *SaveSpaceV2Request {
	return &SaveSpaceV2Request{}
}

func (p *SaveSpaceV2Request) GetName() string {
	return p.Name
}

func (p *SaveSpaceV2Request) GetDescription() string {
	return p.Description
}

func (p *SaveSpaceV2Request) GetIconURI() string {
	return p.IconURI
}

func (p *SaveSpaceV2Request) GetSpaceType() SpaceType {
	return p.SpaceType
}

type SaveSpaceRet struct {
	ID           *int64 `thrift:"id,1,optional" form:"id" json:"id,omitempty" query:"id"`
	CheckNotPass *bool  `thrift:"check_not_pass,2,optional" form:"check_not_pass" json:"check_not_pass,omitempty" query:"check_not_pass"`
}

func NewSaveSpaceRet() *SaveSpaceRet {
	return &SaveSpaceRet{}
}

type SaveSpaceV2Response struct {
	Data     *SaveSpaceRet  `thrift:"data,1,optional" form:"data" json:"data,omitempty" query:"data"`
	Code     int64          `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg      string         `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp *base.BaseResp `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}

func NewSaveSpaceV2Response() *SaveSpaceV2Response {
